...
namespace Sitescope2RemoteWrite.Storage
{
    ...
    public class ReplicationStateStorageMySQL : IReplicationStateStorage
    {
        private readonly ILogger<ReplicationStateStorageMySQL> _logger;
        ...
        public ReplicationStateStorageMySQL(ILogger<ReplicationStateStorageMySQL> logger, IConfiguration configuration)
        {
            _logger = logger;
